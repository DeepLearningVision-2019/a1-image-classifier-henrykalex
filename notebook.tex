...
{\color{incolor}In [{\color{incolor}9}]:} \PY{k+kn}{import} \PY{n+nn}{cv2} \PY{c+c1}{\PYZsh{} computer vision library}
...
\end{verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}5}]:} \PY{c+c1}{\PYZsh{} Image data directories}
...
accessed by index: \texttt{IMAGE\_LIST{[}0{]}{[}:{]}}.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}20}]:} \PY{c+c1}{\PYZsh{} Using the load\PYZus{}dataset function in helpers.py}
         ...
         \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{IMAGE\PYZus{}LIST}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,}\PY{n}{IMAGE\PYZus{}LIST}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{)}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
IMAGE\_LIST [[252 255 253]
 [252 255 253]
 [252 255 253]
 {\ldots}
 [ 93  93  75]
...
images}\label{visualize-sample-day-and-night-images}}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}11}]:} \PY{c+c1}{\PYZsh{} Select an image and its label by list index}
...
\textbf{standardized} list of resized images and numerical labels.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}40}]:} \PY{c+c1}{\PYZsh{} Standardize all training images}
...
Display a standardized image from STANDARDIZED\_LIST.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}41}]:} \PY{c+c1}{\PYZsh{} Display a standardized image and its label}
...
night.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}42}]:} \PY{c+c1}{\PYZsh{} Find the average Value or brightness of an image}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}43}]:} \PY{c+c1}{\PYZsh{} Testing average brightness levels}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
Avg brightness: 99.07796666666667

    \end{Verbatim}

\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}43}]:} <matplotlib.image.AxesImage at 0x7f38bd058eb8>
\end{Verbatim}
...
input RGB image.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}44}]:} \PY{c+c1}{\PYZsh{} This function should take in RGB image input}
...
testing accuracy.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}45}]:} \PY{k+kn}{import} \PY{n+nn}{random}
...
and their true labels, in a list called \texttt{misclassified}.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}46}]:} \PY{c+c1}{\PYZsh{} Constructs a list of misclassified images given a list of test images and their labels}
         \PY{k}{def} \PY{n+nf}{get\PYZus{}misclassified\PYZus{}images}\PY{p}{(}\PY{n}{test\PYZus{}images}\PY{p}{)}\PY{p}{:}
             ...
             \PY{k}{for} \PY{n}{image} \PY{o+ow}{in} \PY{n}{test\PYZus{}images}\PY{p}{:}
                 ...
                 \PY{n}{predicted\PYZus{}label} \PY{o}{=} \PY{n}{none}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}47}]:} \PY{c+c1}{\PYZsh{} Find all misclassified images in a given test set}
...
difficult to classify.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}48}]:} \PY{c+c1}{\PYZsh{} Visualize misclassified example(s)}
